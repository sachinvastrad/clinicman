...
export const NAV_ITEMS = [
  ...
  { label: "Yoga Library", href: "/yoga-library",      icon: "Activity",        permission: "clinical:write" as Permission },
  { label: "Diet Templates",href: "/diet-templates",   icon: "Salad",           permission: "clinical:write" as Permission },
  { label: "MagicDiet",    href: "/magic-diet",        icon: "Sparkles",        permission: "clinical:write" as Permission },
  { label: "Billing",      href: "/billing",           icon: "Receipt",         permission: "billing:write" as Permission },
  { label: "Outstanding",  href: "/billing/outstanding",icon: "AlertCircle",    permission: "billing:write" as Permission },
  { label: "Packages",     href: "/billing/packages",  icon: "Layers",          permission: "billing:write" as Permission },
  { label: "Inventory",    href: "/inventory",         icon: "Package",         permission: "inventory:write" as Permission },
  { label: "Vendors",      href: "/inventory/vendors", icon: "Truck",           permission: "inventory:write" as Permission },
  { label: "Stock-In",     href: "/inventory/stock-in",icon: "PackagePlus",     permission: "inventory:write" as Permission },
  { label: "Leads",        href: "/leads",             icon: "TrendingUp",      permission: "leads:write" as Permission },
  { label: "Lead Kanban",  href: "/leads/kanban",      icon: "Kanban",          permission: "leads:write" as Permission },
